...
export default function DeletePopup({id}) {
    ...
    const deleteInvoice = async (id) => {
        ...
        const newInvoices = data.docs.filter( (doc) => {
                ...
                <ScrollLock>
                    ...
                    >
                        <Popup variants={popupAnimation}>
                            ...
                            <Buttons>
                                <Button secondary onClick={() => dispatch(popUp(false))}>Cancel</Button>
                                <Button alert onClick={ () => deleteInvoice(id, invoice) }>Delete</Button>
                            </Buttons>
                        </Popup>
                    </Backdrop>
                </ScrollLock>
